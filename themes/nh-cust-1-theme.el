;;; nh-cust-1-theme.el --- Theme

;; Copyright (C) 2023 , Nicholas Huber
...
;;; Commentary:
;;; nh-cust-1 theme created by Nicholas Huber in 2023
...
;; Misc
   ...
   `(fringe ((,class (:background ,linenumbg :foreground ,linenumfg))))
   `(cursor ((,class (:background ,fg4))))
   `(isearch ((,class (:bold t :foreground ,warning :background ,bg3))))
;; Modeline
   `(mode-line ((,class (:box (:line-width 1 :color nil) :bold t :foreground ,fg4 :background ,modelinebg))))
...
;; ORG
   ...
   `(org-block ((,class (:foreground ,fg3 :background ,blockbg))))
...
(provide-theme 'nh-cust-1)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; nh-cust-1-theme.el ends here
